...
export const createTherapySettings = form(TherapySettingsSchema, async (request) => {
  const { locals } = getRequestEvent();
  const { apiClient } = locals;
  try {
...
export const updateTherapySettings = form(z.object({ id: z.string(), request: TherapySettingsSchema }), async ({ id, request }) => {
  const { locals } = getRequestEvent();
  const { apiClient } = locals;
  try {
...
export const createBasalSchedule = form(BasalScheduleSchema, async (request) => {
  const { locals } = getRequestEvent();
  const { apiClient } = locals;
  try {
...
export const updateBasalSchedule = form(z.object({ id: z.string(), request: BasalScheduleSchema }), async ({ id, request }) => {
  const { locals } = getRequestEvent();
  const { apiClient } = locals;
  try {
