...
public interface IPasskeyService
{
    ...
    Task<PasskeyCredentialResult> CompleteRegistrationAsync(string attestationResponseJson, string challengeCookie, Guid tenantId);
    ...
    Task<PasskeyAssertionResult> CompleteAssertionAsync(string assertionResponseJson, string challengeCookie, Guid tenantId);
...
public record PasskeyRegistrationOptions(string OptionsJson, string ChallengeCookie);
public record PasskeyAssertionOptions(string OptionsJson, string ChallengeCookie);
